export const schema = {
  ...
  definitions: {
    ...
    date: {
      $comment:
        "Note to tool implementers: it is necessary to cast YAML 'date' objects to string objects when validating against this schema.",
    ...
    'license-enum': {
      $comment:
        'Use https://github.com/citation-file-format/get-spdx-licenses to update this enum in the future',
      description:
    ...
    'swh-identifier': {
      $comment:
        'Software Heritage identifiers are documented here: https://docs.softwareheritage.org/devel/swh-model/persistent-identifiers.html.',
      description:
  ...
  properties: {
    ...
    repository: {
      ...
      examples: ['https://edoc.hu-berlin.de/handle/18452/23016', 'https://ascl.net/2105.013'],
    },
    'repository-artifact': {
      $ref: '#/definitions/url',
